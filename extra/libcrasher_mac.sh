#!/bin/bash
#Diff avec version Linux : compilation sans -lbsd, add tester_mac et changement substr ligne 119
#pour etre compatible avec les anciennes versions de BASH
...
function test_fx ()
{
	...
	verbose \
	&& echo "Running : gcc -Wall -Wextra -Werror testers_mac/ft_${1}_t.c -I . -L . -lft -o ft_${1}_t"
	gcc -Wall -Wextra -Werror testers_mac/ft_${1}_t.c -I . -L . -lft -o ft_${1}_t
	if [ $? -eq 0 ]
	then
