...
function test_fx ()
{
	...
	verbose \
	&& echo "Running : gcc -Wall -Wextra -Werror testers/ft_${1}_t.c -I . -L . -lft  -L . -lbsdmini -o ft_${1}_t"
	gcc -Wall -Wextra -Werror testers/ft_${1}_t.c -I . -L . -lft -L . -lbsdmini -o ft_${1}_t
	if [ $? -eq 0 ]
	then
